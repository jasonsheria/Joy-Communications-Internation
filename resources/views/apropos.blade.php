    ...
    <div class="we-are-block">
        ...
        <div id="about-us-section">
            ...
            <div class="about-us-image">
                ...
                <img src="{{url('storage/banniere/child-malnutrition.jpg')}}" width="808" height="458" alt="Lobby Image">

            </div>

            <div class="about-us-info">

                <h2>Nous sommes une Association d'aide humanitaires</h2>
                ...
                <a href="#" title="About Us Button">Apropos de Nous!</a>
        ...
        <div id="history-section">
            ...
            <div class="history-image">
                ...
                <img src="{{ url('storage/banniere/8960ADFC-383E-42A6-8E21-68B24E34A42F.jpeg') }}" style="width: 100%;height: 100%;" alt="Building Pic">

            </div>

            <div class="history-info">

                <h2>Histoire de creation</h2>
